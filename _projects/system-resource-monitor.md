...
description: "Full-screen terminal monitor in C for Linux CPU, memory, swap, disk, and network usage, with aligned progress bars, per-core views, and trend sparklines."
